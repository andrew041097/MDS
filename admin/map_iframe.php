...
<!-- took out: onmouseout="this.style.visibility='hidden' " -->
	<span  id='block_pointer'  onclick="put_pixels(event);" style='cursor: pointer;position:absolute;left:13;top:377;background-color:#FFFFFF; visibility:hidden; '><img name='pointer_img' src='pointer.png'></span>
